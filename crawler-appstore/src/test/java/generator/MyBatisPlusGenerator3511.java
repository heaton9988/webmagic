 ...
 */
public class MyBatisPlusGenerator3511 {
    private static final List<String> INCLUDE_TABLES = Lists.newArrayList("c_appinfo");
    ...
    public static final String projectName = "crawler_appstore";

    public static void main(String[] args) {
        FastAutoGenerator.create(JDBC_MYSQL_URL, JDBC_USERNAME, JDBC_PASSWORD) // 数据库连接
                .globalConfig(builder -> builder.author("zhijun.zhou") // 作者
                        .enableSwagger().outputDir("/Users/xingchuan/Desktop/mybatis-plus-generator/" + projectName + "/src/main/java") //
                ...
                .packageConfig(builder -> builder //
                        .parent("com.zzj.crawler.appstore") //
                        .entity("entity") //
                        .mapper("mapper") //
                        .service("repo") //
                        .serviceImpl("repo.impl") //
                        .xml("mappers") //
                ) //
                .strategyConfig(builder -> builder.addInclude(INCLUDE_TABLES) //
                        .addTablePrefix("c_") //
                        .entityBuilder() //
                        .enableLombok() //
